function blogBuilder($) {
    ...
    function buildSettings() {
        settings = {
            ...
            popup: $(document.getElementById('mg-blog-builder-wrap')),
            popupOpenClass: 'blog-builder-open',
            popupContent: $(document.getElementById('mg-blog-builder-content')),
            module: $('.blog-builder-module'),
            panel: $(document.getElementById('mg-blog-builder-panel')),
